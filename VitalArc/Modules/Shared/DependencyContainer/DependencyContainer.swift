...
//  VitalArc
//
//  Orchestrator dependency injection container.
//  Delegates to domain-specific sub-containers.
//
...
final class DependencyContainer {
    ...
    var analyticsRepository: AnalyticsRepository { shared.analyticsRepository }
